...
module Hcaptcha
  module Adapters
    module ViewMethods
      ...
      # `Hcaptcha::Helpers.recaptcha_v3_execute_function_name(action)` to get the name of the
      # function to call.
      def recaptcha_v3(options = {})
        ::Hcaptcha::Helpers.recaptcha_v3(options)
      end

      # Renders a reCAPTCHA [v2 Checkbox](https://developers.google.com/recaptcha/docs/display) widget
      def recaptcha_tags(options = {})
        ::Hcaptcha::Helpers.recaptcha_tags(options)
      end
      ...
      def invisible_recaptcha_tags(options = {})
        ::Hcaptcha::Helpers.invisible_recaptcha_tags(options)
      end
    end
  end
end
